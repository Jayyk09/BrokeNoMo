...
function App() {
  ...
  return (
    <div className="flex h-screen bg-gradient-to-br from-[#0f0f2d] via-[#1f1f5a] to-[#3a1f7a] text-gray-100">
      {/* Left Sidebar */}
      <div className="w-[10%] min-w-[200px] flex flex-col h-full border-r border-gray-800/50 bg-gray-900/80">
        {/* Fixed Username */}
      ...
      <div className="w-1/4 min-w-[300px] border-l border-gray-800/50 p-6 bg-gray-900/80">
